...
UNIQUE INDEX `ID_CANAL_UNIQUE` (`ID_CANAL` ASC),
...
UNIQUE INDEX `COD_FAMILIA_COMERCIAL_UNIQUE` (`COD_FAMILIA_COMERCIAL` ASC),
UNIQUE INDEX `NOME_FAMILIA_COMERCIAL_UNIQUE` (`NOME_FAMILIA_COMERCIAL` ASC));
...
INDEX `fk_produto_familia_comercial1_idx` (`COD_FAMILIA_COMERCIAL` ASC),
...
INDEX `fk_sku_phase_produto3_idx` (`SKU_PHASE_IN` ASC),
INDEX `fk_sku_phase_produto4_idx` (`SKU_PHASE_OUT` ASC),
...
INDEX `fk_historico_produto_idx` (`PRODUTO_SKU` ASC),
INDEX `fk_historico_canal1_idx` (`ID_CANAL` ASC),
