...
public abstract class SQL {
	...
	public static final String FAMILIA_UPSERT;
	
	static {

		FAMILIA_UPSERT = ResourceManager.getSQL("familia.upsert"); // $NON-NLS-1$
    	PRODUTO_UPSERT = ResourceManager.getSQL("produto.upsert"); //$NON-NLS-1$
    	CANAL_UPSERT = ResourceManager.getSQL("canal.upsert"); //$NON-NLS-1$
		PHASE_UPSERT = ResourceManager.getSQL("phase.upsert"); //$NON-NLS-1$
